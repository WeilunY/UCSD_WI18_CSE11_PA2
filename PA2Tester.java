...
public class PA2Tester {
	...
	public static void main(String[] args) {
		PA2Tester pa2Tester = new PA2Tester();

		System.out.println("*********Begin Submission Script  PA**************");
		double score = pa2Tester.calculateScore();

		System.out.print("Score on this tester " + score + "/30\n");
		if (score != 30) {
			System.out.println(pa2Tester.scoreInfo);
		}
